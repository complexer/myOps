...
urlpatterns = [
    ...
    path('ws_file_delete/', views.ws_file_delete, name='ws_file_delete'),
    path('ws_dir_delete/', views.ws_dir_delete, name='ws_dir_delete'),
    ...
    path('get_commit_diff_file/<str:repo_name>/<str:commit_base_id>/<str:commit_compare_id>', views.get_commit_diff_file, name='get_commit_diff_file'),
